...
export const Footer = () => {
  return (
    <Box  w='100vw' h='6vh' display='flex' justifyContent='center' >
<Box  bg='#141414'  h='70%' display='flex' flexDirection={['column','column','row','row','row']} justifyContent='center' alignItems='center'>
